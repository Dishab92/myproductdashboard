...
export function AgentHelperTableView({ items, weights, onEdit, onDelete, customerSafe }: AgentHelperTableViewProps) {
      ...
      <table className="w-full text-xs">
        <thead className="sticky top-0 z-10 bg-muted/80 backdrop-blur-sm">
          <tr>
            ...
            <th className="text-center px-2 py-2.5 font-medium text-muted-foreground w-[80px]">Actions</th>
          </tr>
        </thead>
        <tbody>
          {scored.map((item) => (
